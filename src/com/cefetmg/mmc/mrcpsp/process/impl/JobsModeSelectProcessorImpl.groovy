...
import com.cefetmg.mmc.mrcpsp.model.enums.EnumJobsMode;
 ...
 *
 */
public class JobsModeSelectProcessorImpl implements JobsModeSelectProcessor {
	
	private static final Logger log = Logger.getLogger(JobsModeSelectProcessorImpl.class);	
