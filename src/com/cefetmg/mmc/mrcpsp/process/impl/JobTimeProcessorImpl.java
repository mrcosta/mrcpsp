...
public class JobTimeProcessorImpl implements JobTimeProcessor {

	private static final Logger log = Logger.getLogger(JobTimeProcessorImpl.class);
	
	private RestrictionsProcessor restrictionsProcessor;
	private JobOperations jobOperations;
	private JobPriorityRulesOperations jprOperations; 
	
	public JobTimeProcessorImpl() {
		restrictionsProcessor = new RestrictionsProcessorImpl();
		jobOperations = new JobOperationsImpl();
		jprOperations = new JobPriorityRulesOperationsImpl();
	}
